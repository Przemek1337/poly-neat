...
Run from the repository root:
    uv run python examples/xor_neatdbm.py [--cpu | --gpu]

Artifacts are written to examples/xor_neatdbm_artifacts/:
...
_ARTIFACTS_DIR = _THIS_DIR / "xor_neatdbm_artifacts"


def main() -> None:
    device = parse_device_from_cli()
    config = pn.NEATDBMConfig.load_from_yaml_file(_THIS_DIR / "xor_neatdbm.yaml")
