...
Run it as a module from the repository root::
    ...
    uv run python -m examples.pediatric_pneumonia.transfer_learning_smoke
...
def run_experiment(
    ...
    payload = yaml.safe_load(CONFIG_FILE_PATH.read_text(encoding="utf-8"))["transfer_learning"]
