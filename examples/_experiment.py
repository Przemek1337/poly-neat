...
EXAMPLE_REGISTRY: dict[str, str] = {
    ...
    "cifar10/benchmark_deepneat": "examples.cifar10.benchmark_deepneat",
    ...
    "mnist/benchmark_deepneat": "examples.mnist.benchmark_deepneat",
    "mnist/benchmark_exact": "examples.mnist.benchmark_exact",
