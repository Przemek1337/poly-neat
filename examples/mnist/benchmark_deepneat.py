"""DeepNEAT on the MNIST comparison protocol.
...
This is the comparison runner, distinct from ``examples.mnist.deepneat`` which
reproduces the source experiment. DeepNEAT genomes carry no weights, so the
...
from examples.mnist._methods import make_deepneat_search
...
def run_experiment(
    ...
    """Run one DeepNEAT search through the MNIST protocol and report both tracks."""
