"""Freeze verified CIFAR-10 profiles into an immutable v2 lock, after pilots, without testing.
...
CIFAR-10's required method and its fitness metric.
"""
...
def freeze_series(
    *,
    ...
    """Freeze a CIFAR-10 series: DeepNEAT only, on validation accuracy."""
