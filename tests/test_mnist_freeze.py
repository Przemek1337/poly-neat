"""Freezing an MNIST series binds it to its pilots, profiles, seeds and environment.
...
from examples.mnist._freeze import DEFAULT_METHODS, freeze_series
